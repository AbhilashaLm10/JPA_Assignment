...
import com.cg.jpacrud.services.AuthorService;
import com.cg.jpacrud.services.AuthorServiceImpl;
...
AuthorService service = new AuthorServiceImpl();
		...
		do{
		 ...
		 case 1:
		        ...
		        author.setFirstName("Abhilasha");
		        author.setMiddleName("Ramesh");
		        author.setLastName("Limaje");
	         	author.setPhoneNo("9089886767");
